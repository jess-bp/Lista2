...
function dadosDoUsuario(){
    console.log("\n");
    let horasAtividadeFisica = prompt("Quantas horas de exercicios fisico foi feito neste mês? ");
    return horasAtividadeFisica;
    
}

function calculaPontosDinheiro(horasAtividadeFisica){
    let totalPontos;
    let totalDinheiro;
    ...
    if(horasAtividadeFisica <= 10 && horasAtividadeFisica >= 0){
        ...
        console.log(`\nVocê conseguiu ${totalPontos} pontos e ganhou R$ ${totalDinheiro}`);
    }
...
calculaPontosDinheiro(dadosDoUsuario());